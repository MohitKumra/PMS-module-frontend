...
export function AnalyticsPage() {
  ...
  return (
    <div className="max-w-[1400px] mx-auto flex flex-col gap-6 sm:gap-8">
      ...
      {/* Summary cards */}
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 stagger animate-fade-in">
        <StatCard 
      ...
      {projects && projects.length > 0 && (
        <Card variant="default" className="overflow-hidden animate-scale-in">
